...
const GAME_CONFIG = Object.freeze({
  title: 'Türkiye Altın Yatakları Oyunu',
  menuTitle: "Türkiye'nin Altın Yatakları",
  taskText: 'Altın yatağı bulunan illeri bul.',
  ...
  mineData: Object.freeze([
    ...
    { label: "Midi", cityId: "gumushane", x: 705.98, y: 135.9 },
    { label: "İliç-Çöpler", cityId: "erzincan", x: 666.68, y: 198.88 },
    { label: "Bakırtepe", cityId: "sivas", x: 623.58, y: 212.14 },
    { label: "Altıntepe", cityId: "ordu", x: 604.17, y: 104.65 },
    { label: "Himmetdede", cityId: "kayseri", x: 515.62, y: 255.7 },
    { label: "Mahmatlar", cityId: "kayseri", x: 505.68, y: 266.59 },
    { label: "Kaymaz", cityId: "eskisehir", x: 304.9, y: 200.3 },
    { label: "Söğüt", cityId: "bilecik", x: 231.51, y: 150.58 },
    { label: "Lapseki", cityId: "canakkale", x: 68.47, y: 126.15 },
    { label: "Ovacık", cityId: "izmir", x: 75.08, y: 198.6 },
    { label: "Çukuralan", cityId: "izmir", x: 67.19, y: 208.61 },
    { label: "Arapdağ", cityId: "izmir", x: 69.54, y: 244.84 },
    { label: "Efemçukuru", cityId: "izmir", x: 67.7, y: 265.23 },
    { label: "Sart", cityId: "manisa", x: 110.31, y: 241.41 },
    { label: "Kızıltepe", cityId: "balikesir", x: 129.42, y: 190.19 },
    { label: "Kışladağ", cityId: "usak", x: 172.28, y: 253.02 },
    { label: "Cerattepe", cityId: "artvin", x: 833.32, y: 72.78 }
  ])
});
