...
const GAME_CONFIG = Object.freeze({
  title: 'Türkiye Asbest Yatakları Oyunu',
  menuTitle: "Türkiye'nin Asbest Yatakları",
  taskText: 'Asbest (Amyant) yatağı bulunan illeri bul.',
  learnTitle: 'Asbest Yatakları Öğren Modu',
  finishTitle: 'Tüm Asbest Yatakları Bulundu',
  cityLabelOverrides: Object.freeze({
    // Örnek: izmir: { x: 92, y: 235 }
  }),
  mineData: Object.freeze([
  { label: " ", cityId: "sivas", x: 585.7, y: 169.76 },
  { label: " ", cityId: "amasya", x: 523.91, y: 113.65 },
  { label: " ", cityId: "amasya", x: 517.52, y: 127.14 },
  { label: " ", cityId: "eskisehir", x: 258.97, y: 164.57 },
  { label: " ", cityId: "balikesir", x: 108.83, y: 158.01 },
  { label: " ", cityId: "hatay", x: 548.77, y: 407.42 }
  ])
});
